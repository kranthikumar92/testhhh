...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HMNCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hmncointools.com", "104.207.132.196"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"hmncointools.com", "testnet-seed.hmncointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HMNCoin is probably already running."), addrBind.ToString().c_str());
        else
